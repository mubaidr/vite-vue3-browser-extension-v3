...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/common/auth/change-password': RouteRecordInfo<'/common/auth/change-password', '/common/auth/change-password', Record<never, never>, Record<never, never>>,
    '/common/auth/profile': RouteRecordInfo<'/common/auth/profile', '/common/auth/profile', Record<never, never>, Record<never, never>>,
    '/common/auth/recover': RouteRecordInfo<'/common/auth/recover', '/common/auth/recover', Record<never, never>, Record<never, never>>,
    '/common/auth/signin': RouteRecordInfo<'/common/auth/signin', '/common/auth/signin', Record<never, never>, Record<never, never>>,
    '/common/auth/signup': RouteRecordInfo<'/common/auth/signup', '/common/auth/signup', Record<never, never>, Record<never, never>>,
